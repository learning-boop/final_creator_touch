import CreatorsTouchHome from "./_components/home/CreativeSearchHome";

export const metadata = {
  title: "Creators Touch Global — Web Design, Development & SEO, Vijayawada",
  description:
    "Creators Touch Global is a digital studio in Vijayawada, India. Since 2008: web design, development, ecommerce, SEO and online marketing for 2000+ brands across retail, education, automotive, media and government.",
  alternates: { canonical: "https://creatorstouchglobal.com" },
  openGraph: {
    title: "Creators Touch Global — Web Design, Development & SEO, Vijayawada",
    description:
      "Strategy, branding, content, web design and development under one roof since 2008. 2000+ brands across retail, education, healthcare, jewellery and government.",
